<template>
    <div class="bg-principal">
        ...
        <!-- Videos -->
        <p class="text-2xl text-white pt-4 sm:pl-16 md:pl-10">
            Uploads
        </p>
        <div class="pb-[50rem] pt-4 sm:grid sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8 md:px-10 md:gap-2">
